...
export alias "k get" = kg
export alias "k edit" = ke
export alias "k attach" = ka
export alias "k apply" = kaf
export alias "k create" = kc
export alias "k delete" = kdel
export alias "k describe" = kd
export alias "k top po" = ktp 
export alias "k top pod" = ktp 
export alias "k top pods" = ktp 
export alias "k top no" = ktno
export alias "k top node" = ktno
export alias "k top nodes" = ktno
export alias "k get no" = kube-get-node
export alias "k get node" = kube-get-node
export alias "k get nodes" = kube-get-node
